        ...
        <form className="myform">
          ...
          <div class="overlay">
            <div class="wrap">
              ...
              <br />
              <a
                href="https://www.facebook.com/CSIVITAP/"
                target="_blank"
                class="fa fa-facebook"
              ></a>
              <a
                href="mailto:csiclubofficial@csivitap.co.in"
                class="fa fa-google"
              ></a>
              <a
                href="https://www.linkedin.com/company/csivitap/"
                target="_blank"
                class="fa fa-linkedin"
              ></a>
              <a
                href="https://www.instagram.com/csi_vitap/"
                target="_blank"
