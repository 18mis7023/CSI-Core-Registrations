      ...
      (snapShot) => {
        ...
        // gets the download url then sets the image from firebase as the value for the imgUrl key:
           ...
           const registerref=firebase.database().ref(`CSI/Registration/${firebase.auth().currentUser.uid}`);
            ...
            if(name!="" && email!=""  && phonenum!="" && registrationnum!="" && phonenum.length==10 && registrationnum.length>=9 && validator.isEmail(email) && imageAsUrl!="" && branch!="" && dob!="" && department!="" && gender!=""){
                ...
                <div className="col-sm-7 left" >
                    ...
                    <form className="force-overflow" onSubmit={submitregistration}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" className="form-control" name="nopos" id="phnum" placeholder="9494616023" required onChange={setphonenum} value={phonenum}/>
                        </div>
                        <div className="form-group">
                            <label>Date Of Birth *</label>
                            <input type="date" className="form-control" name="deadline" id="dob" placeholder="July 27 2021" required onChange={setdob} value={dob}/>
                        </div>
                        <div className="form-group">
                            <label>Gender *</label>
                            <select className="form-control" name="gender" id="gender" onChange={setgender}>
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-control" name="department" id="department" onChange={setdepartment}>
                                <option value="">---SELECT----</option>
                        ...
                        <div className="form-group">
                            <label>Address</label>
                            <textarea className="form-control" name="aboutc" id="exampleFormControlInput1" placeholder="Company Details" rows="5" required onChange={setaddress} value={address}/>
                        </div>
                        <motion.button 
                            type="submit"
                            className="btn sub"
